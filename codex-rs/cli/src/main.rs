...
fn merge_interactive_cli_flags(interactive: &mut TuiCli, subcommand_cli: TuiCli) {
    ...
    if subcommand_cli.local {
        interactive.local = true;
    }
    if subcommand_cli.synthetic {
        interactive.synthetic = true;
    }
    if subcommand_cli.openrouter {
        interactive.openrouter = true;
    }
    if subcommand_cli.safe {
        interactive.safe = true;
    }
