...
pub enum WireApi {
    ...
    /// Used by custom providers (Synthetic, OpenRouter, LM Studio) that do not
...
pub const LMSTUDIO_LOCAL_PROVIDER_ID: &str = "lmstudio-local";
pub const SYNTHETIC_PROVIDER_ID: &str = "synthetic";
    ...
    [
        ...
        (
            ...
            ModelProviderInfo {
                ...
                env_key: Some("SYNTHETIC_API_KEY".into()),
                env_key_instructions: Some(
                    "Get an API key at https://synthetic.new and set SYNTHETIC_API_KEY"
                        .into(),
                ),
                experimental_bearer_token: None,
        ...
        (
            ...
            ModelProviderInfo {
                ...
                env_key_instructions: Some(
                    "Get an API key at https://openrouter.ai/keys and set OPENROUTER_API_KEY"
                        .into(),
                ),
                experimental_bearer_token: None,
                wire_api: WireApi::Responses,
